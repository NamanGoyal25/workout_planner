...
class _HistoryPageState extends State<HistoryPage> {
  ...
  void initState() {
    ...
    // Initialize selectedMonth with the current month abbreviation
...
class WeekPlanPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String weekMonthYear =
        'Week$weekNumber,$selectedMonth$selectedYear'; // Format the week, month, and year
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .doc(widget.userId)
            .collection(
                'Week${widget.weekNumber},${widget.selectedMonth}${widget.selectedYear}')
            .doc(widget.day)
            .collection('executed')
            .snapshots(),
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
